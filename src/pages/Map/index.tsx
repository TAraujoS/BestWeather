      ...
      <MainDash>
        ...
        <ContainerGeneral>
          {!capital.current ? (
            ...
            <div>
              <figure>
                <img src={capital.current?.condition?.icon} alt="" />
              </figure>
              <p>
                {capital.location.name} / {capital.location.region}
              </p>
              <p>{capital.current.temp_c}ºC</p>
            </div>
          )}
          <ContainerMap>
            <img
